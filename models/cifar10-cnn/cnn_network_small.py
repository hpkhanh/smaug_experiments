...
def create_cnn_model():
  with sg.Graph(name="cnn_smv", backend="SMV",
    ...
    input_tensor = sg.Tensor(
        data_layout=sg.NHWC, tensor_data=generate_unified_data((1, 4, 4, 3), 0.05))
    conv0_tensor = sg.Tensor(
        data_layout=sg.NHWC, tensor_data=generate_unified_data((4, 3, 3, 3), 0.05))
    bn0_mean_tensor = sg.Tensor(
        data_layout=sg.NC, tensor_data=generate_unified_data((1, 4), 0.05))
    ...
    conv1_tensor = sg.Tensor(
        data_layout=sg.NHWC, tensor_data=generate_unified_data((4, 3, 3, 4), 0.05))
    ...
    conv2_tensor = sg.Tensor(
        data_layout=sg.NHWC, tensor_data=generate_unified_data((8, 3, 3, 4), 0.05))
    conv3_tensor = sg.Tensor(
        data_layout=sg.NHWC, tensor_data=generate_unified_data((8, 3, 3, 8), 0.05))
    bn2_mean_tensor = sg.Tensor(
        data_layout=sg.NC, tensor_data=generate_unified_data((1, 8), 0.05))
    ...
    fc0_tensor = sg.Tensor(
        data_layout=sg.NC, tensor_data=generate_unified_data((4, 8), 0.05))
    fc1_tensor = sg.Tensor(
        data_layout=sg.NC, tensor_data=generate_unified_data((10, 4), 0.05))
